...
export type PageArticle = Entry & {
  ...
  name?: Maybe<Scalars['String']>;
  productsCollection?: Maybe<PageArticleProductsCollection>;
  seoFields?: Maybe<ComponentSeo>;
  slug?: Maybe<Scalars['String']>;
  sys: Sys;
  topicsCollection?: Maybe<PageArticleTopicsCollection>;
};
...
/** To output data for a single piece of produced content. [See type definition](https://app.contentful.com/spaces/r11leasokahm/content_types/pageArticle) */
export type PageArticleFeaturedImageArgs = {
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
};
...
/** To output data for a single piece of produced content. [See type definition](https://app.contentful.com/spaces/r11leasokahm/content_types/pageArticle) */
export type PageArticleProductsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
...
/** To output data for a single piece of produced content. [See type definition](https://app.contentful.com/spaces/r11leasokahm/content_types/pageArticle) */
export type PageArticleTopicsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  order?: InputMaybe<Array<InputMaybe<PageArticleTopicsCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
...
export type PageArticleFilter = {
  ...
  sys?: InputMaybe<SysFilter>;
  topics?: InputMaybe<CfPageTopicNestedFilter>;
...
export type PageArticleLinkingCollectionsPageLandingCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  order?: InputMaybe<Array<InputMaybe<PageArticleLinkingCollectionsPageLandingCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
};
...
export enum PageArticleLinkingCollectionsPageLandingCollectionOrder {
  HeroBannerHeadlineColorAsc = 'heroBannerHeadlineColor_ASC',
  HeroBannerHeadlineColorDesc = 'heroBannerHeadlineColor_DESC',
  HeroBannerHeadlineAsc = 'heroBannerHeadline_ASC',
  HeroBannerHeadlineDesc = 'heroBannerHeadline_DESC',
...
export type PageArticleProductsCollection = {
  __typename?: 'PageArticleProductsCollection';
  items: Array<Maybe<Entry>>;
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  total: Scalars['Int'];
...
export type PageArticleTopicsCollection = {
  __typename?: 'PageArticleTopicsCollection';
...
export enum PageArticleTopicsCollectionOrder {
  DescriptionAsc = 'description_ASC',
  DescriptionDesc = 'description_DESC',
  HeroBannerHeadlineColorAsc = 'heroBannerHeadlineColor_ASC',
  HeroBannerHeadlineColorDesc = 'heroBannerHeadlineColor_DESC',
...
export type PageLanding = Entry & {
  ...
  articlesCollection?: Maybe<PageLandingArticlesCollection>;
  contentfulMetadata: ContentfulMetadata;
  ...
  seoFields?: Maybe<ComponentSeo>;
  sys: Sys;
  topicsCollection?: Maybe<PageLandingTopicsCollection>;
};


/** To have an entry point for the app [See type definition](https://app.contentful.com/spaces/r11leasokahm/content_types/pageLanding) */
export type PageLandingArticlesCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  order?: InputMaybe<Array<InputMaybe<PageLandingArticlesCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
...
/** To have an entry point for the app [See type definition](https://app.contentful.com/spaces/r11leasokahm/content_types/pageLanding) */
export type PageLandingTopicsCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  locale?: InputMaybe<Scalars['String']>;
  order?: InputMaybe<Array<InputMaybe<PageLandingTopicsCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']>;
  skip?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PageTopicFilter>;
};

export type PageLandingArticlesCollection = {
  __typename?: 'PageLandingArticlesCollection';
  items: Array<Maybe<PageArticle>>;
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  total: Scalars['Int'];
...
export enum PageLandingArticlesCollectionOrder {
  InternalNameAsc = 'internalName_ASC',
  InternalNameDesc = 'internalName_DESC',
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
...
export type PageLandingTopicsCollection = {
  __typename?: 'PageLandingTopicsCollection';
  items: Array<Maybe<PageTopic>>;
  limit: Scalars['Int'];
  skip: Scalars['Int'];
  total: Scalars['Int'];
...
export enum PageLandingTopicsCollectionOrder {
  DescriptionAsc = 'description_ASC',
  DescriptionDesc = 'description_DESC',
  HeroBannerHeadlineColorAsc = 'heroBannerHeadlineColor_ASC',
  HeroBannerHeadlineColorDesc = 'heroBannerHeadlineColor_DESC',
...
/** To have a place for topic-based hubs. [See type definition](https://app.contentful.com/spaces/r11leasokahm/content_types/pageTopic) */
export type PageTopicTopicsArgs = {
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
  where?: InputMaybe<PageTopicFilter>;
};
...
export type PageTopicFilter = {
  ...
  sys?: InputMaybe<SysFilter>;
  topics?: InputMaybe<CfPageTopicNestedFilter>;
  topics_exists?: InputMaybe<Scalars['Boolean']>;
};
...
export type BasePageArticleFieldsFragment = { __typename: 'PageArticle', internalName?: string | null, slug?: string | null, name?: string | null, description?: string | null, sys: { __typename?: 'Sys', id: string, spaceId: string }, seoFields?: (
    { __typename?: 'ComponentSeo' }
    & SeoFieldsFragment
  ) | null, featuredImage?: (
    { __typename?: 'Asset' }
...
export type PageArticleFieldsFragment = (
  { __typename?: 'PageArticle', productsCollection?: { __typename?: 'PageArticleProductsCollection', items: Array<{ __typename?: 'ComponentSeo' } | { __typename?: 'PageArticle' } | { __typename?: 'PageLanding' } | (
      { __typename?: 'PageProduct' }
      & BasePageProductFieldsFragment
    ) | { __typename?: 'PageTopic' } | { __typename?: 'Static' } | null> } | null, topicsCollection?: { __typename?: 'PageArticleTopicsCollection', items: Array<(
      { __typename?: 'PageTopic' }
      & BasePageTopicFieldsFragment
    ) | null> } | null }
  & BasePageArticleFieldsFragment
);
...
export type PageArticleCollectionQueryVariables = Exact<{
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
}>;
...
export type PageLandingFieldsFragment = { __typename: 'PageLanding', internalName?: string | null, heroBannerHeadline?: string | null, heroBannerHeadlineColor?: string | null, sys: { __typename?: 'Sys', id: string, spaceId: string }, seoFields?: (
    ...
    ) | null> } | null, topicsCollection?: { __typename?: 'PageLandingTopicsCollection', items: Array<(
      { __typename?: 'PageTopic' }
      & PageTopicFieldsFragment
    ) | null> } | null, articlesCollection?: { __typename?: 'PageLandingArticlesCollection', items: Array<(
      { __typename?: 'PageArticle' }
      & PageArticleFieldsFragment
    ) | null> } | null };
...
export type PageTopicFieldsFragment = (
  { __typename?: 'PageTopic', productsCollection?: { __typename?: 'PageTopicProductsCollection', items: Array<(
      { __typename?: 'PageProduct' }
      & BasePageProductFieldsFragment
    ) | null> } | null, articlesCollection?: { __typename?: 'PageTopicArticlesCollection', items: Array<(
      { __typename?: 'PageArticle' }
      & BasePageArticleFieldsFragment
    ) | null> } | null }
  & BasePageTopicFieldsFragment
...
export type PageTopicQueryVariables = Exact<{
  slug: Scalars['String'];
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
}>;
...
export type PageTopicQuery = { __typename?: 'Query', pageTopicCollection?: { __typename?: 'PageTopicCollection', items: Array<(
      { __typename?: 'PageTopic' }
      & PageTopicFieldsFragment
    ) | null> } | null };

export type PageTopicCollectionQueryVariables = Exact<{
  locale?: InputMaybe<Scalars['String']>;
  preview?: InputMaybe<Scalars['Boolean']>;
}>;


export type PageTopicCollectionQuery = { __typename?: 'Query', pageTopicCollection?: { __typename?: 'PageTopicCollection', items: Array<(
      { __typename?: 'PageTopic' }
      & PageTopicFieldsFragment
    ) | null> } | null };
...
export const BasePageTopicFieldsFragmentDoc = gql`
  ...
  featuredTopicImage {
    ...
    `;
export const BasePageArticleFieldsFragmentDoc = gql`
...
${BasePageArticleFieldsFragmentDoc}
${SeoFieldsFragmentDoc}
${ImageFieldsFragmentDoc}
${BasePageProductFieldsFragmentDoc}
${BasePageTopicFieldsFragmentDoc}`;
export const PageArticleCollectionDocument = gql`
    query pageArticleCollection($locale: String, $preview: Boolean) {
  pageArticleCollection(limit: 100, locale: $locale, preview: $preview) {
    items {
      ...PageArticleFields
    }
  }
...
export const PageTopicDocument = gql`
...
${BasePageProductFieldsFragmentDoc}
${BasePageArticleFieldsFragmentDoc}`;
export const PageTopicCollectionDocument = gql`
    query pageTopicCollection($locale: String, $preview: Boolean) {
  pageTopicCollection(limit: 100, locale: $locale, preview: $preview) {
    items {
      ...PageTopicFields
    }
  }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    pageArticle(variables: PageArticleQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PageArticleQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PageArticleQuery>(PageArticleDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'pageArticle', 'query');
    },
    pageArticleCollection(variables?: PageArticleCollectionQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PageArticleCollectionQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PageArticleCollectionQuery>(PageArticleCollectionDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'pageArticleCollection', 'query');
    },
    ...
    pageTopic(variables: PageTopicQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PageTopicQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PageTopicQuery>(PageTopicDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'pageTopic', 'query');
    },
    pageTopicCollection(variables?: PageTopicCollectionQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<PageTopicCollectionQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PageTopicCollectionQuery>(PageTopicCollectionDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'pageTopicCollection', 'query');
    }
  };
}
